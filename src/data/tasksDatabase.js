...
export const tasksDatabase = {
  1: [ // Website Redesign
    { id: 1, title: 'Design homepage mockup', description: 'Create new homepage design in Figma', status: 'completed', assignedTo: 'JD' },
    ...
    { id: 4, title: 'Add animations', description: 'Implement smooth scroll animations', status: 'in-progress', assignedTo: 'JD' },
    { id: 5, title: 'Mobile responsiveness', description: 'Make site responsive for mobile', status: 'in-progress', assignedTo: 'SM' },
    ...
    { id: 8, title: 'Performance audit', description: 'Run Lighthouse audit', status: 'todo', assignedTo: 'SM' },
    { id: 9, title: 'Content migration', description: 'Migrate old content to new design', status: 'completed', assignedTo: 'AL' },
    { id: 10, title: 'Final review', description: 'Complete final review and launch', status: 'todo', assignedTo: 'JD' }
  ],
  2: [ // Mobile App Development
    { id: 11, title: 'Setup project structure', description: 'Initialize React Native project', status: 'completed', assignedTo: 'KS' },
    { id: 12, title: 'Design UI components', description: 'Create reusable UI components', status: 'completed', assignedTo: 'RJ' },
    ...
    { id: 16, title: 'Offline mode', description: 'Implement offline functionality', status: 'todo', assignedTo: 'RJ' },
    ...
    { id: 21, title: 'Beta testing', description: 'Conduct beta testing phase', status: 'todo', assignedTo: 'KS' },
    ...
    { id: 25, title: 'Launch', description: 'Official app launch', status: 'todo', assignedTo: 'KS' }
  ],
  3: [ // Marketing Campaign
    { id: 26, title: 'Market research', description: 'Conduct target market analysis', status: 'completed', assignedTo: 'TW' },
    { id: 27, title: 'Create content calendar', description: 'Plan content for 3 months', status: 'completed', assignedTo: 'BH' },
    { id: 28, title: 'Design social media assets', description: 'Create graphics for social media', status: 'completed', assignedTo: 'CN' },
    { id: 29, title: 'Write blog posts', description: 'Write 10 blog posts', status: 'completed', assignedTo: 'PM' },
    ...
    { id: 32, title: 'Influencer outreach', description: 'Contact and collaborate with influencers', status: 'completed', assignedTo: 'CN' },
  ...
  4: [ // Database Migration
    ...
    { id: 35, title: 'Setup new database', description: 'Configure new database server', status: 'completed', assignedTo: 'LP' },
    ...
    { id: 39, title: 'Data validation', description: 'Validate migrated data', status: 'in-progress', assignedTo: 'LP' },
    ...
    { id: 42, title: 'Training', description: 'Train team on new database', status: 'todo', assignedTo: 'MK' },
    ...
    { id: 45, title: 'Final review', description: 'Complete final review', status: 'todo', assignedTo: 'LP' }
  ],
  5: [ // API Integration
    { id: 46, title: 'API documentation review', description: 'Review third-party API docs', status: 'completed', assignedTo: 'GH' },
    { id: 47, title: 'Setup API keys', description: 'Obtain and configure API keys', status: 'completed', assignedTo: 'NP' },
    ...
    { id: 51, title: 'Error handling', description: 'Implement error handling', status: 'completed', assignedTo: 'QR' },
    ...
    { id: 55, title: 'Integration tests', description: 'Write integration tests', status: 'completed', assignedTo: 'GH' },
    ...
    { id: 59, title: 'Security audit', description: 'Complete security review', status: 'in-progress', assignedTo: 'NP' },
    ...
    { id: 63, title: 'Update UI', description: 'Update UI to use API data', status: 'in-progress', assignedTo: 'QR' },
    { id: 64, title: 'Final testing', description: 'Complete final testing', status: 'todo', assignedTo: 'GH' },
  ...
  6: [ // User Testing Phase
    ...
    { id: 67, title: 'Create test scenarios', description: 'Write user testing scenarios', status: 'todo', assignedTo: 'AB' },
    ...
    { id: 70, title: 'Collect feedback', description: 'Gather user feedback', status: 'todo', assignedTo: 'YZ' },
  ...
  7: [ // Security Audit
    ...
    { id: 73, title: 'Penetration testing', description: 'Conduct penetration tests', status: 'completed', assignedTo: 'EF' },
    ...
    { id: 77, title: 'Access control', description: 'Review access control policies', status: 'completed', assignedTo: 'GH' },
    ...
    { id: 80, title: 'Fix vulnerabilities', description: 'Fix identified issues', status: 'completed', assignedTo: 'GH' },
  ...
  8: [ // Content Management System
    ...
    { id: 83, title: 'Database design', description: 'Design CMS database schema', status: 'completed', assignedTo: 'KL' },
    ...
    { id: 87, title: 'Media manager', description: 'Build media upload and management', status: 'in-progress', assignedTo: 'KL' },
    ...
    { id: 90, title: 'API endpoints', description: 'Create REST API for content', status: 'in-progress', assignedTo: 'IJ' },
    ...
    { id: 93, title: 'Localization', description: 'Add multi-language support', status: 'todo', assignedTo: 'OP' },
    { id: 94, title: 'SEO features', description: 'Add SEO optimization features', status: 'in-progress', assignedTo: 'IJ' },
    { id: 95, title: 'Testing', description: 'Test CMS functionality', status: 'todo', assignedTo: 'KL' },
    ...
    { id: 98, title: 'Performance optimization', description: 'Optimize CMS performance', status: 'in-progress', assignedTo: 'IJ' },
  ...
  9: [ // Analytics Dashboard
    ...
    { id: 101, title: 'Design dashboard UI', description: 'Design dashboard layout', status: 'completed', assignedTo: 'ST' },
    ...
    { id: 105, title: 'Filters and segments', description: 'Add data filtering options', status: 'todo', assignedTo: 'ST' },
    ...
    { id: 110, title: 'Performance optimization', description: 'Optimize dashboard performance', status: 'todo', assignedTo: 'QR' },
    ...
    { id: 113, title: 'Launch', description: 'Launch analytics dashboard', status: 'todo', assignedTo: 'ST' }
  ]
};
